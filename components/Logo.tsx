    ...
    return (
        <>
            ...
            <div className="relative flex items-end group transition">
                ...
                {/* <p className="absolute left-10 top-1/2 -translate-y-1/2 text-xl font-bold">Steves Steam Tool</p> */}
                <p className="text-3xl text-gray-400 flex gap-0 font-bold tracking-tighter leading-6 transition -ml-2 z-10">
                    <p className="text-gray-400 overflow-hidden w-[1.05rem] group-hover:w-auto transition-all">Steves</p>
                    <p className="text-gray-500 overflow-hidden w-[1.05rem] group-hover:w-auto transition-all">Steam</p>
                    <p className="text-gray-600 w-4 overflow-hidden group-hover:w-16 transition-all">Tool</p>
                </p>
            </div>
        </>
    )
